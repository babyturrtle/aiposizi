...
@bp.route("/episodes/<int:ep_id>/edit", methods=("GET", "POST"))
...
@bp.route("/add_episode", methods=("GET", "POST"))
def add_episode():
    """ Add new episode. """
...
@bp.route("/episodes/<int:ep_id>/delete", methods=("POST",))
...
@bp.route("/seasons/<int:s_id>/edit", methods=("GET", "POST"))
...
@bp.route("/episodes/<int:s_id>/delete", methods=("POST",))
...
@bp.route("/characters/<int:char_id>/")
...
@bp.route("/crew/<int:crew_id>/edit", methods=("GET", "POST"))
...
@bp.route("/crew/<int:crew_id>/delete", methods=("POST",))
